		...
		<div class="sidebar">
			<div class="menu">
				...
				<div class="container">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/pages/orderlist.jsp">
								<img
						...
						<li><a
							href="<%= request.getContextPath() %>/AdminLogoutServlet"> <img
								src="${pageContext.request.contextPath}/stylesheets/images/settings.svg"
								alt="product"> <span>Logout</span>
						</a></li>
					</ul>
				</div>
			</div>
