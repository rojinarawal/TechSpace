...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/stylesheets/productdec.css">
...
<body class="productdescription">
	<section class="productdesc_image">
		...
		<img
			...
			alt="${product.productname}" class="productdesc_product_image">
	</section>
	<section class="productdesc_info">
		...
		<div class="productdesc_price_quantity">
			<div class="productdesc_pq">
				<span class="productdesc_topic_headings">PRICE</span> <span
					class="productdesc_price_amount">Rs ${product.price}</span>
			</div>
			<div class="productdesc_pq">
		...
		<div class="productdesc_totalprice">
			<span class="productdesc_topic_headings">TOTAL PRICE</span> <span
				class="productdesc_totalprice_amount">Rs ${product.price}</span>
		</div>
		<div class="productdesc_all_buttons">
			<form action="/TechSpace/ViewCartItems" method="post">
				<input type="hidden" name="productID" value="${product.productID}">
				<input type="hidden" name="quantity" value="1">
				<button type="submit" class="productdesc_button">ADD TO
					CART</button>
			</form>
