            ...
            <div class="nav_right">
                <nav>
                    <ul class="nav_bar">
                        ...
                        <li class="dropdown">
                            <a href="${pageContext.request.contextPath}/pages/product.jsp">SHOP <i class="fa-solid fa-chevron-down"></i></a>
                        </li>
                ...
                <div class="icons">
                    <nav class="navbar">
                        <a href="${pageContext.request.contextPath}/pages/userprofile.jsp" class="navbar-icon">
                            <i class="fa-regular fa-user"></i>
                        </a>
                        <a href="#" class="navbar-icon" style="margin: 0 16px;">
                            <i class="fa-solid fa-cart-shopping"></i>
                        </a>
<!-- Add this form within your existing HTML where the search icon is -->
    		<form id="searchForm"  action="/TechSpace/SearchServlet" method="get" class="search-form">
    ...
    <c:forEach var="product" items="${productList}">
        <div class="product" data-category="${product.category}">
            <div class="product-card">
                <img src="${pageContext.request.contextPath}/stylesheets/images/${product.imageUrlFromPart}" alt="${product.productname}">
                <button class="add-to-cart-btn">Add to Cart</button>
            </div>
            <h3>${product.productname}</h3>
            <p class="price">Rs. ${product.price}</p>
            <a href="${pageContext.request.contextPath}/pages/productdescp.jsp?productId=${product.productID}" class="view-desc-btn">View Description</a>
        </div>
    </c:forEach>
</div>
