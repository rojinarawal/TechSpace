                            ...
                            <form action="#">
                                ...
                                <div class="as_info_one">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="text" name="" placeholder="lux@gmail.com" required pattern=".*@gmail.com">
                                    </div>
                                </div>
                                <div class="as_info_one">
                                    <div class="input-box">
                                        <span class="details">Address</span>
                                        <input type="text" name="" placeholder="Your current address" required>
                                    </div>
                                    <div class="input-box">
                                        <span class="details">Phone Number</span>
                                        <input type="text" name="" placeholder="Your contact number" required maxlength="10" >
                                    </div>
                                </div>
